  ...
  return (
    <div className="drawer drawer-end">
      ...
      <div className="drawer-content flex flex-col">
        <div className="w-full navbar bg-base-100 fixed top-0 z-50 px-10">
          <div className="flex-1 px-2 mx-2 text-3xl font-bold">Clean Co.</div>
          ...
          <div className="flex-none hidden lg:block">
            <ul className="menu menu-horizontal gap-x-4">
              ...
              <li className="dropdown dropdown-hover dropdown-end">
                <label
                  tabIndex="0"
                  className="btn btn-primary rounded-lg btn-outline"
                >
                  Book Now
                </label>
